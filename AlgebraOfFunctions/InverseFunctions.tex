...
Go to \link{http://wolframalpha.com} and type in \verb|inverse function f(x)=2x/(x-1)| to see the output.
...
You can solve for $C$, but instead please use \link{http://wolframalpha.com} to do it for you.


$C=$ \answer{$5/9*(F-32)$}
\begin{hint}
Just enter \verb|inverse function F=9/5*C+32| in \link{http://wolframalpha.com}.
\end{hint}
