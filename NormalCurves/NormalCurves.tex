...
\begin{document}
\begin{abstract}
We delve more deeply into the statistics of normal curves.
\end{abstract}
\maketitle
...
\begin{itemize}
    \item Understand the meaning of the \emph{standard deviation} of a data set and be able to compute it correctly.
    \item Understand the meaning of a Z-score
