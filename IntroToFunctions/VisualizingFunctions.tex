...
\begin{question}
Go to \link{http://desmos.com} and define the three functions 
\[
...
\begin{question}
At \link{http://desmos.com} define a function $f(x)=\sqrt[3]{\frac{1}{x+4}}$. Then find $f(1.6)$ accurate to three decimal places.
